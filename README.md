...
| `DeepUnbranded`                            | Removes a brand from a type recursively.                                     | An API accepts the underlying value of a branded object.                                   |
...
| `indexBy`         | Indexes objects by a selected string or number valued property. | You need to look up objects by a key.                                           |
